...
void entry(unsigned long magic, unsigned long addr) {
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        while (mod_count < mbi->mods_count) {
            ...
            file_sys_ptr  = (void*)(mod->mod_start);
    ...
    /* 0 - base shell for terminal 0
       6 - base shell for terminal 1
       12 - base shell for terminal 2 */
    init_pcb_start(12);
    init_pcb_start(6);
    init_pcb_start(0);
    PIT_init();
